    ...
    <div style={styles.loginContainer}>
      <div style={styles.loginCard}>
        ...
        <div>
          ...
          <button
            onClick={() => {
              setUser({ email: 'usuario@email.com' });
          ...
          <p style={{textAlign: 'center', color: 'rgba(255,255,255,0.8)', fontSize: '14px', marginTop: '20px'}}>
            Esqueceu a senha? <span style={{textDecoration: 'underline', cursor: 'pointer'}}>Clique aqui</span>
          </p>
        </div>

        <div style={{marginTop: '40px', textAlign: 'center', color: 'rgba(255,255,255,0.7)', fontSize: '14px'}}>
          <p>(41)91234-5678</p>
          <p>LAVACAR.r&v@gmail.com</p>
        </div>
      </div>
    </div>
  );
